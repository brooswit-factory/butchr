...
maintain its own butchr-managed sensor set — typed references across seven
provider kinds (`jira-work-item`, `jira-project`, `confluence-page`,
`github-issue`, `github-pr`, `filesystem`, `webpage`) — independent of any
