 ...
 */
const CAPTURE_NAME = /^(?:[A-Z][A-Z0-9]*(?:-\d+)?|(?:jira-work|github-issue|github-pr|jira-idea|zendesk-ticket|filesystem):[a-z0-9-]+:[A-Za-z0-9%._~-]+)-(?:unrecognised|no-reset-time)-(\d{8}T\d{6}Z)\.txt$/;
