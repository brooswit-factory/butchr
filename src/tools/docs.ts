...
/** BUTCHR-437: exported so `src/jira-watch/confluence-poller.ts` can resolve a description-derived Confluence URL to a page id without a second regex disagreeing with this one. */
