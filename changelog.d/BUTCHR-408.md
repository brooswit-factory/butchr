...
- The real Candlestix tier -> model table (provisional pending the boss's answer on BUTCHR-408 — the branch the ticket names could not be found anywhere reachable).
